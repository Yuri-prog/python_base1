...
class Men:  # TODO здесь корректнее задать имя класса как Human (от человек, а не мужчины - Men)
...
class Husband(Men):
    ...
    def __init__(self, name):
        # TODO потому, что в конструкторе здесь не вызван конструктор родительского класса super().__init__(name=name)
...
class Wife(Men):  # TODO жена - трансгендер? 🤔

    def __init__(self, name):
        # TODO здесь аналогично замечанию из Husband
        self.name = name
