...
get_score('811/X--3/XX171/46')  # TODO фрейм 46 должен вызывать ошибку (сумма очков не может быть больше 9)
get_score('811/X--3/XX171/00')  # TODO нули хорошо бы тоже как ошибку учитывать
# TODO ведь по ТЗ за нулевой счёт у нас идёт символ -
